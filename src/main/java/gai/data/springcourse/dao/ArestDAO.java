...
public class ArestDAO {
  ...
  public List<ArestAMT> Serch_Arest(String kart_id) {
    List<ArestAMT> ArAMT = new ArrayList<>();
    ...
    try {
      ...
      while (resultSet.next()) {
        ...
        ArstAMT.setData_out(resultSet.getString("data_out"));
        ...
        ArstAMT.setIsh_answer1(resultSet.getFloat("ish_answer1"));
        ArstAMT.setIsh_answer2(resultSet.getFloat("ish_answer2"));
        ...
        ArstAMT.setTime_fix(resultSet.getDate("time_fix")); // DateTime
